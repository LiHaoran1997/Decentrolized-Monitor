package springcloud.hellospringcloudalibabanacosmonitor.qps;
import java.sql.*;
import java.text.SimpleDateFormat;
import java.util.Date;

public class Consistency {
    public final static String URL="jdbc:mysql://127.0.0.1:3306/new_test?useSSL=false";
...
//            sql="INSERT INTO NEW_TEST(id,age,retime) VALUES('GUOSHUAI',13,'"+getTime()+"')";
    ...
    public static void main(String args[]){
        insert("ribbon",Timestamp.valueOf("2020-03-21 19:34:08.12"),"provider",2,3,4,31,32,5,6);
    }
